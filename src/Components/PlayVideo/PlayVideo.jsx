...
const PlayVideo = () => {
    ...
    //     const commentData_url = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&maxResults=25&videoId=${videoId}&key=${API_KEY}`;
    //     await fetch(commentData_url).then(res => res.json()).then(data => setCommentData(data.items));
    // }
        ...
        <div className='play-video'>
            ...
            <div className='publisher'>
                ...
                <div>
                    ...
                    <span>{channelData ? value_converter(channelData.statistics.subscriberCount) : "-K"} Subscribers</span>
                </div>
                <button>Subscribe</button>
            </div>
            <div className="vid-description">
                <p>{apiData ? apiData.snippet.description.slice(0, 250) : "Description Here"}</p>
                {/* <p>Subscribe GreatStack to see more Lorem ipsum dolor sit amet.</p> */}
                <hr />
